...
class FlagCalculator : public BitHelpers
{
public:
    FlagCalculator();
    ///
    ...
    ///
    static uint8_t simpleFlags(uint8_t value,uint8_t sreg=0){
    ...
    ///
    static uint8_t additionFlags(uint8_t r1, uint8_t r2, uint8_t sreg=0){
