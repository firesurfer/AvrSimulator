...
cmdADC::cmdADC(MemoryMapper *_dataMemory):CommandBase(_dataMemory)
{
...
uint32_t cmdADC::Execute(uint16_t instruction, uint16_t &ProgramCounter, ProcessorFlags &flags)
{
