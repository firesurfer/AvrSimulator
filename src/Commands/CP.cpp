...
CP::CP(MemoryMapper *_dataMemory):CommandBase(_dataMemory)
{
    command = 0b0001010000000000;
    commandMask = 0b1111110000000000;
    numArgs = 2;
    commandSize = 1;
}

uint64_t CP::Execute(uint16_t instruction, uint16_t &ProgramCounter)
{
